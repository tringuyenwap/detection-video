...
class yolov3:
    ...
    def predict(self, feature_maps):
        ...
        confs = tf.concat(confs_list, axis=1, name="yolo/pred_confs")
        # shape: [N, (13*13+26*26+52*52)*3, class_num]
        probs = tf.concat(probs_list, axis=1, name="yolo/pred_probs")
        ...
        boxes = tf.concat([x_min, y_min, x_max, y_max], axis=-1, name="yolo/pred_boxes")
