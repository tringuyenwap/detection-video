...
class YoloV3:
    ...
    def __init__(self, confidence_threshold, config, is_rgb=False):
        ...
        object_detector_nn_path = "/content/detection-video/models/yolov3/yolov3.ckpt.data-00000-of-00001"
    ...
    def get_detections_batch(self, images):
        ...
        _, resize_ratio, dw, dh = self.letterbox_resize(dummy_image, self.input_size[0], self.input_size[1], True)
